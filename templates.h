...
"<tr><td>"STRING_SUBJECT":</td><td><input type = \"text\" name = \"input_name\" style='width:100%%'/></td>"
"<td><input type =\"submit\" value='"STRING_POST_BUTTON"'/></td></tr>"
"<tr><td>"STRING_OPTIONS":</td><td colspan='2'><input type = \"text\" name = \"input_email\" style='width:100%%' id='opt'/></td></tr>"
"<tr><td rowspan='2'>"STRING_COMMENT":</td>"
...
"&nbsp;<a class='button' href='javascript:void(0)' onclick='var e=document.getElementById(\"comment\");e.value += e.value ? \"\\n>>No.\" : \">>No.\";e.focus();'>&gt;&gt;No.Thread</a></td></tr>"
"<tr><td>"STRING_IMAGE":</td><td colspan='2'><input type=\"file\" name=\"input_file\" style='width:100%%'/></td></tr>"
"</table>"
"</form>";

char *show_hide_button =
"<div id='showdiv' style='text-align: center'><button class='wp-btn'"
"onclick='document.getElementById(\"posttable\").className=\"postform\"; document.getElementById(\"showdiv\").className=\"hiding\"'>"
"&#128172;&nbsp;"STRING_NEW_THREAD
"</button><button class='wp-btn' onclick='window.location=\"/list\";'>&#128100;&nbsp;"STRING_MY_POSTS"</button></div>";
